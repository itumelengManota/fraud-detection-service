...
/**
 * Comprehensive integration tests for RiskScoringService.
 *
 ...
 * - Different transaction types and channels
 */
@SpringBootTest
@DisabledInAotMode
@ActiveProfiles("test")
...
@DisplayName("RiskScoringService Integration Tests")
@Execution(ExecutionMode.SAME_THREAD) // Sequential for Redis state consistency
class RiskScoringServiceIntegrationTest extends AbstractIntegrationTest {
    ...
    // ========================================
    // Amount-Based Risk Tests
    // ========================================

    @Nested
    @DisplayName("Amount-Based Risk Detection")
    @TestMethodOrder(MethodOrderer.OrderAnnotation.class)
    class AmountBasedRiskTests {
    ...
    // ========================================
    // Velocity-Based Risk Tests
    // ========================================

    @Nested
    @DisplayName("Velocity-Based Risk Detection")
    @TestMethodOrder(MethodOrderer.OrderAnnotation.class)
    class VelocityBasedRiskTests {
    ...
    @Nested
    @DisplayName("Geographic Risk Detection")
    @TestMethodOrder(MethodOrderer.OrderAnnotation.class)
    class GeographicRiskTests {
