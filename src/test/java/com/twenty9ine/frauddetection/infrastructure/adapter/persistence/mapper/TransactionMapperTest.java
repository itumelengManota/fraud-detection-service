...
/**
 * Comprehensive integration tests for TransactionMapper.
 *
...
@DisplayName("TransactionMapper Integration Tests")
@Execution(ExecutionMode.CONCURRENT)
class TransactionMapperTest extends AbstractIntegrationTest {
    ...
    class DomainToEntityMappingTests {
        ...
        @Test
        @DisplayName("Should map complete transaction with all fields")
        ...
        @Test
        @DisplayName("Should map merchant details correctly")
        ...
        @Test
        @DisplayName("Should return null merchant when absent")
        ...
        @Test
        @DisplayName("Should map device ID correctly")
        ...
        @Test
        @DisplayName("Should return null device when absent")
        ...
        @Test
        @DisplayName("Should map all location fields correctly")
        ...
        @Test
        @DisplayName("Should return null location when absent")
        ...
        @Test
        @DisplayName("Should map minimal transaction with required fields only")
    ...
    class IndividualFieldMappingTests {
        ...
        @Test
        @DisplayName("Should map currency to code correctly")
        ...
        @Test
        @DisplayName("Should map transaction type enum correctly")
        ...
        @Test
        @DisplayName("Should map channel enum correctly")
        ...
        @Test
        @DisplayName("Should create merchant entity with all fields")
